    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          {(project.year || project.medium || project.dimensions) && (
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                {project.medium && (
                  <div>
                    <span className="font-medium">Technique :</span> {project.medium}
                  </div>
                )}
                {project.dimensions && (
                  <div>
                    <span className="font-medium">Dimensions :</span> {project.dimensions}
                  </div>
                )}
              </div>
            </div>
      ...
      <div className="mt-16 pt-8 border-t border-gray-200">
        <div className="flex justify-between items-center">
          {projectId > 1 && (
            <Link href={`/projet/${projectId - 1}`} className="text-sm hover:underline">
              ← Projet précédent
            </Link>
          )}
